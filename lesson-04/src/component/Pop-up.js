...
class PopUp{
    constructor(){
        ...
        this.element.classList.add('absolute', 'top-1/2', 'left-1/2','w-80','p-2', 'h-52', 'text-white', 'bg-gray-400', 'rounded', 'text-center','transform','-translate-x-1/2','-translate-y-1/2')
    }
    sendSuccess(){
